...
--
-- Host: localhost
-- Generation Time: Jul 22, 2015 at 01:40 PM
...
INSERT INTO `admission` VALUES(1, 'admin', 'adminpass');
...
CREATE TABLE `alert` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `alertpercountry` int(11) NOT NULL,
  `alertpercounty` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;
...
INSERT INTO `alert` VALUES(1, 10, 5);
...
INSERT INTO `doctordetails` VALUES(1, 'doctor1', 'doctor1', 'evans obura', 1, 'examination room 1');
INSERT INTO `doctordetails` VALUES(2, 'doctor2', 'doctor2', 'walala mdogo', 2, 'examination room 2');
INSERT INTO `doctordetails` VALUES(3, 'doctor3', 'doctor3', 'enock ule moja', 2, 'examination room 3');
INSERT INTO `doctordetails` VALUES(4, 'doctor4', 'doctor4', 'elias kiprop', 2, 'examination room 4');
...
INSERT INTO `labdetails` VALUES(1, 'lab', 'lab');
...
--
-- Dumping data for table `nurselogin`
--

INSERT INTO `nurselogin` VALUES(1, 'nurse', 'nurse');
...
CREATE TABLE `patientdetails` (
  ...
  `needdoctor` int(11) NOT NULL,
  `doctorlab` int(11) NOT NULL,
  `labdoctor` int(11) NOT NULL,
  `doctorpharmacy` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=14 ;
...
INSERT INTO `pharmacydetails` VALUES(1, 'pharmacy', 'pharmacy');

-- --------------------------------------------------------

--
-- Table structure for table `pharmacyreport`
--
...
--
-- Dumping data for table `pharmacyreport`
--
